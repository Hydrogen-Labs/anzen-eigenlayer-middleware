...
import {BLSSignatureChecker, IRegistryCoordinator} from "../BLSSignatureChecker.sol";
    ...
    IAnzenTaskManager
{
    ...
    function postTaskResponseBySigner(
        Task calldata task,
        TaskResponse calldata taskResponse,
        BN254.G1Point memory signedMessage
    ) external {
        ...
        require(
            ...
            "Responded to the task too late"
        );

        // emitting event
        emit TaskSignedByOperator(latestTaskNum - 1, signedMessage, msg.sender);
    }
    ...
    function raiseAndResolveChallenge(
        ...
        address protocol = task.protocol;
        // some logical checks
        require(
        ...
        // TODO: use $EIGEN intersubjective slashing
